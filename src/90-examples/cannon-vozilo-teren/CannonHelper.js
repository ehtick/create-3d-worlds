export class CannonHelper {
  ...
  addVisual(body, color = 0x888888, name = 'mesh', castShadow = true, receiveShadow = true) {
    body.name = name
    if (this.defaultMaterial === undefined && color == 0x888888) this.defaultMaterial = new THREE.MeshLambertMaterial({ color })
    const material = (color == 0x888888) ? this.defaultMaterial : new THREE.MeshLambertMaterial({ color })
