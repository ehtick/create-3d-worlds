...
const particleGeo = new THREE.SphereGeometry(1, 16, 8)
...
export function createVisual(body, color = 0x888888, name = 'mesh', castShadow = true, receiveShadow = true, material = new THREE.MeshLambertMaterial({ color })) {
  body.name = name
  const mesh = shape2Mesh(body, castShadow, receiveShadow, material)
  mesh.castShadow = castShadow
  mesh.receiveShadow = receiveShadow
  body.threemesh = mesh
  return mesh
