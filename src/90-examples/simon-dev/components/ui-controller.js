...
export class UIController extends Component {
  ...
  InitComponent() {
    ...
    if (this.chatElement_) this.chatElement_.addEventListener('keydown', e => this.OnChatKeyDown_(e), false)
  }
  ...
  OnQuestsClicked_(msg) {
    const { visibility } = this._ui.quests.style
    this.HideUI_()
    this._ui.quests.style.visibility = (visibility ? '' : 'hidden')
  }

  OnStatsClicked_(msg) {
    const { visibility } = this._ui.stats.style
    this.HideUI_()
