...
res = await loadModel({ file: 'animal/flamingo.glb', size: 60, shouldCenter: true, shouldAdjustHeight: true })
...
res = await loadModel({ file: 'animal/horse.glb', size: 40, shouldCenter: true, shouldAdjustHeight: true })
