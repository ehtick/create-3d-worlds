    ...
    body.shapes.forEach(function(shape) {
      ...
      switch (shape.type) {
        ...
        case CANNON.Shape.types.PLANE:
          ...
          const floorMap = THREE.ImageUtils.loadTexture('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMaznkwKbnlWTf0zzL9uQrUQ2Q54MfyI7JC5m62icHR5oRjT1v')
          floorMap.wrapS = floorMap.wrapT = THREE.RepeatWrapping
          floorMap.repeat.set(25, 25)
          const groundMaterial = new THREE.MeshPhongMaterial({ color: new THREE.Color('#111'), specular: new THREE.Color('black'), shininess: 0, bumpMap: floorMap })
