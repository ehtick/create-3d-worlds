...
export default class AmmoControls {
  constructor(object3d, options = {}) {
    ...
    const shape = options.shape !== undefined ? options.shape : AmmoControls.guessShapeFromObject3d(object3d)

    const mass = options.mass !== undefined ? options.mass : AmmoControls.guessMassFromObject3d(object3d)
...
AmmoControls.guessMassFromObject3d = function(object3d) {
  const guessedGeometry = AmmoControls._guessGeometryFromObject3d(object3d)
...
AmmoControls._guessGeometryFromObject3d = function(object3d) {
  let parameters = null
  let type = 'unknown'
...
AmmoControls.prototype.setFriction = function(value) {
