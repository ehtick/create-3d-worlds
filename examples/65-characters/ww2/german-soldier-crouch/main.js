...
const { mesh, animations, animDict } = await loadModel({ file: 'german-soldier.fbx', angle: Math.PI, animDict: germanSoldierCrouchAnimations, prefix: 'character/soldier/', fixColors: true })
