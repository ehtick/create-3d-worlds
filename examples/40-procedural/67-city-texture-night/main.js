...
scene.add(createFloor({ size: mapSize, color: 0x101018 }))
scene.add(createCity({ numBuildings, mapSize, rotateEvery: 2, enlargeEvery: 10, map: createBuildingTexture({ night: true }), colorParams: { colorful: .035, max: 1 } }))
